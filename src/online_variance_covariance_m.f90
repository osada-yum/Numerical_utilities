...
contains
  pure type(online_variance_covariance) function generate_online_variance_covariance(n, arr1, arr2) result(res)
  ...
  pure subroutine add_pair_ovc(this, v1, v2)
    class(online_variance_covariance), intent(inout) :: this
